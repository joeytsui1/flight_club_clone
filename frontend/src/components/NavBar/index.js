...
const NavBar = () => {
    ...
    const searchButton = (
        <button className="nav-search-button">
            <svg width="2rem" height="2rem" viewBox="0 0 16 17" ><g fillRule="evenodd" clipRule="evenodd" fill="currentColor"><path d="M11.0105 11.724C9.84375 12.7271 8.326 13.3333 6.66667 13.3333C2.98477 13.3333 0 10.3486 0 6.66667C0 2.98477 2.98477 0 6.66667 0C10.3486 0 13.3333 2.98477 13.3333 6.66667C13.3333 8.32929 12.7247 9.84975 11.7181 11.0174L15.9969 15.2962L15.2898 16.0033L11.0105 11.724ZM12.3333 6.66667C12.3333 9.79628 9.79628 12.3333 6.66667 12.3333C3.53705 12.3333 1 9.79628 1 6.66667C1 3.53705 3.53705 1 6.66667 1C9.79628 1 12.3333 3.53705 12.3333 6.66667Z"></path></g></svg>
        </button>
    )
    return (
        <>
            <header >
                <div>
                    <button className="home-button" onClick={(e) => {history("/")}}>Home</button>
                </div>
